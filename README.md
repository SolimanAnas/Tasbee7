...
| ⬇️ | **التحميل** | YouTube video/audio downloader — MP3 & MP4 with quality selection |
...
│   ├── download.html           # YouTube video/audio downloader
...
| Download | `pages/download.html` | YouTube video/audio downloader |
